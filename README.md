...
[Download here](https://github.com/marcellozaniboni/httpiccolo/releases/) precompiled binaries for Windows x86 64-bit, Linux x86 64-bit, Linux ARM 64-bit, Linux ARM 32-bit
